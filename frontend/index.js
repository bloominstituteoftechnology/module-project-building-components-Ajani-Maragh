function moduleProject3() {
  ...
  function buildLearnerCard(learner, languages) {
    ...
    [nameP, id, dob, favLang].forEach(p => {
      card.appendChild(p)
    })
  ...
  function buildFooter(footerData) {
    ...
    ContactEmailP.innerHTML = 
    `Email: <a href="mailto: ${footerData.contactEmail}">${footerData.contactEmail}</a>`;
    ...
    for (let platform in footerData.socialMedia) {
      ...
      socialMediaLink.textContent = platform.charAt(0).toUpperCase() + 
      platform.slice(1);
    }
